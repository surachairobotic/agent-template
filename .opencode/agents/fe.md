...
## Input
- DELEGATE from PM: { spec_path, design_path, deliverable: "frontend" }
...
- Send COMPLETE: { deliverable: "frontend", files: ["..."], validation: {passed: true} }
...
## Self-Validation (Run Before COMPLETE)
```bash
